                ...
                <div className="flex-1 p-8 overflow-y-auto bg-slate-50/50 dark:bg-slate-900">
                    ...
                    {activeTab === 'voice' && !isLoadingInitial && (
                        <div className="space-y-8 animate-fade-in max-w-3xl">
                            ...
                            <div className="rounded-xl border border-lime-200 dark:border-lime-900/50 bg-lime-50/80 dark:bg-lime-950/20 p-4">
                                <h4 className="text-sm font-bold text-lime-900 dark:text-lime-200 mb-2">Voice booking — 3 simple steps</h4>
                                <ol className="text-sm text-lime-900/90 dark:text-lime-100/90 space-y-1.5 list-decimal list-inside">
                                ...
                                <p className="text-xs text-lime-800/80 dark:text-lime-200/70 mt-2">
